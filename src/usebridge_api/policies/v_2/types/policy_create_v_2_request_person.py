...
class PolicyCreateV2RequestPerson(UniversalBaseModel):
    ...
    date_of_birth: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="dateOfBirth", description="Date, in the Patient's timezone, expressed as YYYY-MM-DD"),
    ]
