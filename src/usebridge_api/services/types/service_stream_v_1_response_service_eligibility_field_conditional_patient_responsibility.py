...
class ServiceStreamV1ResponseServiceEligibilityFieldConditionalPatientResponsibility(UniversalBaseModel):
    conditions: typing.List[
        ServiceStreamV1ResponseServiceEligibilityFieldConditionalPatientResponsibilitiesElementCondition
    ]
    limit: ServiceStreamV1ResponseServiceEligibilityFieldConditionalPatientResponsibilitiesElementLimit
