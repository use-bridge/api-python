...
class ServicesListV1ResponseItemLocation(UniversalBaseModel):
    ...
    state: ServicesListV1ResponseItemLocationFieldState = pydantic.Field()
    """
    ...
    country: typing.Optional[ServicesListV1ResponseItemLocationFieldCountry] = None
