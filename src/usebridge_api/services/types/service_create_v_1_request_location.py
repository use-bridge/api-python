...
class ServiceCreateV1RequestLocation(UniversalBaseModel):
    ...
    state: ServiceCreateV1RequestLocationFieldState = pydantic.Field()
    """
    ...
    country: typing.Optional[ServiceCreateV1RequestLocationFieldCountry] = None
