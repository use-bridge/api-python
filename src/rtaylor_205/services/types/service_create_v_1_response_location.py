...
class ServiceCreateV1ResponseLocation(UniversalBaseModel):
    ...
    state: ServiceCreateV1ResponseLocationFieldState = pydantic.Field()
    """
    ...
    country: typing.Optional[ServiceCreateV1ResponseLocationFieldCountry] = None
