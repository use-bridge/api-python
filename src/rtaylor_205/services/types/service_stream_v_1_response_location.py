...
class ServiceStreamV1ResponseLocation(UniversalBaseModel):
    ...
    state: ServiceStreamV1ResponseLocationFieldState = pydantic.Field()
    """
    ...
    country: typing.Optional[ServiceStreamV1ResponseLocationFieldCountry] = None
