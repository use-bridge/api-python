...
class ServiceCreateV1ResponseServiceEligibilityFieldConditionalPatientResponsibility(UniversalBaseModel):
    conditions: typing.List[
        ServiceCreateV1ResponseServiceEligibilityFieldConditionalPatientResponsibilitiesElementCondition
    ]
    limit: ServiceCreateV1ResponseServiceEligibilityFieldConditionalPatientResponsibilitiesElementLimit
