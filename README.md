...
A full reference for this library is available [here](https://github.com/use-bridge/api-python/blob/HEAD/./reference.md).
...
```python
client.billing.estimate_charges.create_estimate_charge(..., request_options={
    "max_retries": 1
})
```
